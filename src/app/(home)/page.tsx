    ...
    <div className="min-h-screen">
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-primary mb-6 font-mono text-4xl font-bold md:text-6xl">
            Over Simplified And Flattened Components
          </h2>
          <p className="text-primary mx-auto mb-8 max-w-2xl text-xl">
              ...
              <div className="grid gap-6 md:grid-cols-3">
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <p className="mt-2 text-xs">75% of monthly goal</p>
                  </CardContent>
                </Card>
              </div>
            </TabsContent>
